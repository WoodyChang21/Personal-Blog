...
function Navbar() {
  ...
  return (
    <div
      className="shell sticky top-0 z-50"
      style={{
      ...
      <nav style={{ height: 54, borderBottom: '1px solid rgba(221,220,212,0.1)' }}>
        <div className="page-padding flex h-full items-center justify-between">
          ...
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.borderColor = 'rgba(221,220,212,0.75)';
              e.currentTarget.style.backgroundColor = 'rgba(221,220,212,0.06)';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.borderColor = 'rgba(221,220,212,0.35)';
        ...
        {isMenuOpen && (
          <div
            className="mobile-menu-enter page-padding flex flex-col gap-5 pb-6 pt-4 md:hidden"
